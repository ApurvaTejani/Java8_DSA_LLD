...
public class StudentDatabase {
    ...
    public static List<Student> getAllStudents() {
        Student s1 = new Student("Apurva", 2, 3.6, "male", Arrays.asList("Swimming", "Gymming", "Cricket"), 11);
        Student s2 = new Student("Harish", 2, 3.8, "male", Arrays.asList("Cycling", "Gymming", "Swimming"), 13);
        Student s3 = new Student("Varun", 3, 4.0, "male", Arrays.asList("Swimming", "Aerobics", "Badminton"), 21);
        Student s4 = new Student("Mia", 3, 3.9, "Female", Arrays.asList("Swimming", "Gymming", "Cricket"), 25);
